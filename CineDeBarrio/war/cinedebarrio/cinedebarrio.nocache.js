...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cinedebarrio" because\n';
  ...
  $wnd.__gwt_activeModules['cinedebarrio'] = {
    'moduleName' : 'cinedebarrio',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/cinedebarrio.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cinedebarrio'].superdevmode = true;

  var expectedSuffix = '/cinedebarrio.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cinedebarrio + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cinedebarrio';
  var devModeSessionKey = '__gwtDevModeSession:cinedebarrio';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cinedebarrio/cinedebarrio.nocache.js';
  ...
  $wnd.__gwt_activeModules['cinedebarrio'].canRedirect = true;
  $wnd.__gwt_activeModules['cinedebarrio'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING cinedebarrio';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cinedebarrio?user.agent=' + ua + '&_callback=' + callback;
