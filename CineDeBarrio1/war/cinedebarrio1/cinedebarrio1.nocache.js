...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cinedebarrio1" because\n';
  ...
  $wnd.__gwt_activeModules['cinedebarrio1'] = {
    'moduleName' : 'cinedebarrio1',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/cinedebarrio1.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cinedebarrio1'].superdevmode = true;

  var expectedSuffix = '/cinedebarrio1.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cinedebarrio1 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cinedebarrio1';
  var devModeSessionKey = '__gwtDevModeSession:cinedebarrio1';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cinedebarrio1/cinedebarrio1.nocache.js';
  ...
  $wnd.__gwt_activeModules['cinedebarrio1'].canRedirect = true;
  $wnd.__gwt_activeModules['cinedebarrio1'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING cinedebarrio1';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cinedebarrio1?user.agent=' + ua + '&_callback=' + callback;
